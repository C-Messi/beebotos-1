...
pub fn init_i18n() -> I18nContext {
    ...
    zh.insert("workflows-trigger-context", "触发上下文 (JSON)");
    zh.insert("workflows-trigger-hint", "输入 JSON 对象作为触发上下文");
    ...
    en.insert("workflows-trigger-context", "Trigger Context (JSON)");
    en.insert("workflows-trigger-hint", "Enter a JSON object to pass as trigger context");
