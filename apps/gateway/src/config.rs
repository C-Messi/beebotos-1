...
pub struct McpConfig {
    ...
    /// Acts as a security whitelist. Examples: ["npx", "python",
...
fn default_mcp_retry_count() -> u32 {
    3
}
fn default_mcp_auto_init() -> bool {
    true
}
fn default_mcp_enforce_tls() -> bool {
    true
}
fn default_mcp_http_sse() -> bool {
    false
}
